exports.result = async function prompt_CallWrap_result({ session, logger, action, user_input }) {
    const routine = `app:prompt_CallWrap_result`;
    logger.debug({ routine, message: 'Setting prompt_CallWrap result rules', action, user_input });
